...
namespace MvcSiteMapProvider.Web.Html
{
    ...
    public static class SiteMapPathHelper
    {
        ...
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper)
        {
        ...
        /// <returns>SiteMap path for the current request</returns>
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper, ISiteMapNode startingNode)
        {
        ...
        /// <returns>SiteMap path for the current request</returns>
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper, object sourceMetadata)
        {
        ...
        /// <param name="sourceMetadata">User-defined meta data.</param>
        /// <returns>SiteMap path for the current request</returns>
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper, SourceMetadataDictionary sourceMetadata)
        {
        ...
        /// <returns>SiteMap path for the current request</returns>
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName)
        {
        ...
        /// <param name="templateName">Name of the template.</param>
        /// <returns>SiteMap path for the current request</returns>
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName, object sourceMetadata)
        {
        ...
        /// <param name="templateName">Name of the template.</param>
        /// <returns>SiteMap path for the current request</returns>
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName, SourceMetadataDictionary sourceMetadata)
        {
            return SiteMapPath(helper, templateName, string.Empty, sourceMetadata);
        }
        ...
        /// <returns>SiteMap path for the current request</returns>
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName, string startingNodeKey)
        {
        ...
        /// <param name="sourceMetadata">User-defined meta data.</param>
        /// <returns>SiteMap path for the current request</returns>
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName, string startingNodeKey, object sourceMetadata)
        {
        ...
        /// <param name="sourceMetadata">User-defined meta data.</param>
        /// <returns>SiteMap path for the current request</returns>
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName, string startingNodeKey, SourceMetadataDictionary sourceMetadata)
        {
        ...
        /// <param name="startingNode">The starting node (the last node in the site map path).</param>
        /// <returns>SiteMap path for the current request</returns>
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName, ISiteMapNode startingNode)
        {
        ...
        /// <param name="sourceMetadata">User-defined meta data.</param>
        /// <returns>SiteMap path for the current request</returns>
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName, ISiteMapNode startingNode, object sourceMetadata)
        {
        ...
        /// <param name="sourceMetadata">User-defined meta data.</param>
        /// <returns>SiteMap path for the current request</returns>
        public static IHtmlContent SiteMapPath(this MvcSiteMapHtmlHelper helper, string templateName, ISiteMapNode startingNode, SourceMetadataDictionary sourceMetadata)
        {
